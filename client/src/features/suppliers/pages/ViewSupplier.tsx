            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 pb-6">
                ...
                <div className="flex gap-2">
                    <Button 
                        ...
                        className="h-9 text-[10px] font-bold uppercase tracking-widest border-slate-200 hover:bg-slate-50"
                    >
                        <Pencil size={14} className="mr-2" /> Edit Record
                    </Button>
                    <Button 
                        variant="destructive"
                        onClick={() => { if(confirm("Permanent delete?")) removeSupplier(id!).then(() => navigate('/suppliers')) }}
                        className="h-9 text-[10px] font-bold uppercase tracking-widest bg-rose-500 hover:bg-rose-600 shadow-none"
                    >
